...
//step 7.5 - display total on screen
//step 8 - allows us to add numbers (parseFloat(itemCost))
//step 9 - allows us to use decimals (parseFloat(itemCost))
//step 10 - solve issues of 2 decimal places on item cost (itemCost.toFixed(2))
