 ...
 */
	...
	function question1(){
		$("replace-me").css("replace-me", "replace-me");
	}

	$("#button-1").click(question1);
 ...
 */
	...
	// $("#button-2").click(question2);

/**
 * Question 3:
 * When button 3 is clicked, select the ordered list item that has the class "false-fact".
 * Using jQuery, change the content to read "True Fact".
 */

	// function replaceMe(){
	// 	$("replace-me").html("replace me");
	// }

	// $("replace-me").click(question3);
